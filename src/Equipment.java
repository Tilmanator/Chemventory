...
public class Equipment extends Item
{
	 ...
	 *            the date acquired
	 */
	Equipment(String name, int shoppingType, int department, String quantity, int daysToReminder, String notes,
			int status, String company, String catalog, String msds ,int unitType, String storage, String room, Date date)
	{
